...
public class BlockLink {
	...
	//llamado cuando un caller se desconecta
	public static Sound brokenSound;
	...
	static{
		...
		try{
			clickSound = SoundManager.loadSound("/sound/click.wav");
			boingSound = SoundManager.loadSound("/sound/boing.wav");
			crackSound = SoundManager.loadSound("/sound/crack.wav");
			trashSound = SoundManager.loadSound("/sound/trash.wav");
			brokenSound = SoundManager.loadSound("/sound/broken.wav");
		} catch (Exception e) {
			e.printStackTrace();
...
//			String namePlug=Block.getBlock(plugBlockID).getGenusName();
//			String nameSocket=Block.getBlock(socketBlockID).getGenusName();
//			if ((namePlug.startsWith(BlockStub.CALLER_STUB) || nameSocket.startsWith(BlockStub.CALLER_STUB)) 
////					||
////					(namePlug.startsWith(BlockStub.GETTER_STUB))||
////					(nameSocket.startsWith(BlockStub.SETTER_STUB))
//			){
//				broken=true;
