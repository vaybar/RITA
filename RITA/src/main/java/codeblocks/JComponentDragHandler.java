...
public class JComponentDragHandler implements MouseListener, MouseMotionListener {
    ...
    private static void initHandCursors(){
        openHandCursor = createHandCursor("/images/open_hand.png", "openHandCursor");
        closedHandCursor = createHandCursor("/images/closed_hand.png", "closedHandCursor");
    }
    
    private static Cursor createHandCursor(String location, String cursorName){
        java.net.URL handURL = JComponentDragHandler.class.getResource("/images/open_hand.png");
