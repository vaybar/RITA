...
public class MiniMap extends JPanel implements WorkspaceWidget, MouseListener, MouseMotionListener, SearchableContainer, PageChangeListener {
	...
	public void paint(Graphics g){
		...
		for(Page page : this.blockCanvas.getPages()){
				...
				// dibujar el minimap un 33% mas oscuro que la pagina, para que se diferencie mas del fondo
				g.setColor(new Color((pageColor.getRed()/3)*2, (pageColor.getGreen()/3)*2, (pageColor.getBlue()/3)*2, 200));
