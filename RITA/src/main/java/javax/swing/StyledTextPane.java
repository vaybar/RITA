...
public class StyledTextPane extends JEditorPane {
	private static final long serialVersionUID = 293325539944474725L;
     ...
     */
    public StyledTextPane(StyledDocument doc) throws BadLocationException {
        this();
    ...
    private void replaceSelection(String content, boolean checkEditable) {
        if (checkEditable && !isEditable()) {
            UIManager.getLookAndFeel().provideErrorFeedback(StyledTextPane.this);
            return;
        }
    ...
    private Object invokeComposedTextMethod(final JTextComponent c, final int index, final Class[] argTypes, final Object[] args) {
        return AccessController.doPrivileged(new PrivilegedAction() {
            ...
            public Object run() {
                try {
                    ...
                    if (m == null) {
                        m = JTextComponent.class.getDeclaredMethod(composedTextMethodNames[index], argTypes);
