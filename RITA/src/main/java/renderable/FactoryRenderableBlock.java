...
public class FactoryRenderableBlock extends RenderableBlock {
     ...
     */
    public FactoryRenderableBlock(WorkspaceWidget widget, Long blockID,boolean isLoading){
        super(widget, blockID, isLoading);
    ...
    public void mousePressed(MouseEvent e) {
		...
		createdRB=null;
		//verifica que no trate de escribir 2 veces un método Robocode!
		if (!existsInstances(rBlock,"method"))
    		createdRB = createNewInstance(); 
    		else { 
    			new MessageDialog(Language.get("error.maxInstances"), MessageType.INFO);
    		return;}
