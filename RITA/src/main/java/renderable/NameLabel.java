...
class NameLabel extends BlockLabel{
	...
	public NameLabel(String initLabelText, BlockLabel.Type labelType, boolean isEditable, long blockID,boolean isLoading){ //,boolean isLoading
		super(initLabelText, labelType, isEditable, blockID, true, new Color(255,255,225),isLoading);//,isLoading
