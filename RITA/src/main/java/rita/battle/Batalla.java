...
/**
 * La clase Batalla dispara la ejecuciï¿½n del motor de Robocode. En el campo de
 * batalla se ubicarï¿½n los robots seleccionados para combartir
 * 
...
public class Batalla implements Runnable {
	...
	/**
	 * Ejecuciï¿½n principal de una Batalla en RITA
	 * 
	 * @param arg
	 *            [0] corresponde al path donde estï¿½ instalada la
	 *            aplicaciï¿½n, es necesario para que le motor empiece a buscar
	 ...
	 * @param arg
	 *            [3] enemigos en el campo de batalla, podrï¿½a no existir este
	 *            parï¿½metro
	 * @param arg
	 *            [3] posiciones iniciales de todos los robots en el campo de
	 *            batalla, podrïa no existir este parámetro
	 * */
	...
	public void run() {
		...
		// TODO Como segundo parÃ¡metro se le pueden pasar las posiciones
