...
/**
 * Esta clase representa la invocacion a un EventMethod
 * 
 * @author PERERATARRAGONA
 * */
public class EventMethod extends Command {
  ...
  public List<StringBuffer> render(RenderableBlock rBlock)
    ...
    StringBuffer sb1 = new StringBuffer("event." + rBlock.getBlock().getBlockLabel()+"()");
